...
The trap is structural rather than careless. Saying "the compiler requires this cast because the inferred type lacks the property" feels like rigor; saying "the compiler requires this and I have not established why" feels like weakness. But only the second is honest before the ten-second experiment — delete the cast, run the type checker — has been run.
