...
---
**The law of triviality** is C. Northcote Parkinson's observation that an organization spends time on an agenda item in inverse proportion to how much the item actually matters. His illustration is a committee approving a nuclear power plant in minutes, because almost nobody present understands reactor design well enough to have a confident opinion, followed by a long argument over the bicycle shed for the plant's staff, because everyone has ridden a bike and painted a fence and therefore has a view.
