...
tags:
  - method
summary: The unit of an absolute change in a percentage, and the gap between that and a relative change.
---
...
The reverse framing minimizes: three percentage points off a figure already at 60% reads as noise, though it may be most of the movement available. Neither framing lies by itself; presenting one without the base rate removes the reader's ability to check, which is why giving all three is a [[Plain Language]] obligation rather than a nicety.
