...
tags:
  - meaning
summary: A controlled vocabulary for classifying things, and the choice between hierarchy, facets, and free tagging.
---
A **taxonomy** is a controlled vocabulary for classifying things. The classical form is a hierarchy — each item in exactly one place, categories nesting — which is precise and forces an impossible decision whenever something belongs in two places.
