...
Because information is scarce, vision itself becomes a sub-game — wards, scouts, radar upgrades, and sacrificial units sent in purely to die and reveal a position are all forms of paying a resource cost to buy back certainty. Removing fog of war entirely, an option some [[4X Game]]s and [[Grand Strategy Game]]s offer as a difficulty or multiplayer-fairness setting, doesn't just make the game easier — it changes what's optimal, since scouting investment stops paying off and the winning strategy shifts almost entirely toward pure economic and military efficiency.

[[Open World Design]] borrows the same reveal-the-map instinct at a structural level: a tower climbed to unfog a region of an open-world map is fog of war's core idea, repurposed as a traversal reward rather than an information contest.
