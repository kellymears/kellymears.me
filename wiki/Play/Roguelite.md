...
The real design effect is on what a loss *means* emotionally. In a strict roguelike, dying costs everything accrued in that run, full stop; in a roguelite, dying still ends the run, but the player walks away with something — banked currency, a permanent unlock, experience toward the next meta-tier — which means the [[Compulsion Loop]] never fully resets. This is why roguelites tolerate, and often court, mainstream difficulty expectations that a strict roguelike wouldn't: the sting of an individual death is cushioned by [[Meta-Progression]] that a Berlin-Interpretation purist would say undermines the entire point of permadeath in the first place — a real disagreement about design philosophy, not just branding.

The [[Roguelike Deckbuilder]] hybrid usually leans roguelite in exactly this sense: card and relic unlocks persist across runs even as *Slay the Spire* resets the deck itself to nothing each time.
