...
The mechanism is a boundary the [[Bundler]] recognizes — usually a dynamic import — which becomes a split point. Everything reachable only through that import moves into its own chunk, fetched on demand.
