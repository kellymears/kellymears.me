...
**Retinization** is the adjustment period — commonly two to twelve weeks of dryness, peeling, stinging and transient flare — as turnover accelerates. It fades with continued use, buffered application, and less frequent dosing at the start.

The important correction is that irritation is a poor proxy for effect. Some of the visible peeling is barrier disruption, and treating it as a progress signal is a textbook case of [[Goodhart's Law]]; the [[Nociception]] involved reports nothing about receptor activity. Barrier repair follows the same logic as [[Moist Wound Healing]] — restore the barrier, do not chase the sting. Tretinoin also degrades in light, so evening use and daily sun protection are standard, and systemic retinoids are cleared through routes described in [[Xenobiotic Metabolism]] with teratogenicity requiring strict precautions.
