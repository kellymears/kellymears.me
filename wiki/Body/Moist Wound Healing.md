...
tags:
  - body
summary: Wounds kept moist under an occlusive dressing re-epithelialize faster than wounds allowed to dry and scab.
---
**Moist wound healing** is the practice of keeping a superficial wound covered and hydrated rather than letting it dry into a scab. George Winter's 1962 experiment on porcine skin found that wounds covered with a polythene film re-epithelialized roughly twice as fast as identical wounds left open to air. A scab is not a scaffold; it is desiccated tissue that migrating keratinocytes have to tunnel beneath. Remove the barrier to migration and the cells cross sooner.

The folk instruction to "let it breathe" is a good example of a rationale that sounds mechanistic and is not — oxygen for epithelial migration comes through the perfused wound bed, not the air above it. The intuition earns its persistence from the visible crust looking like progress, which makes it a case study in [[Plausible Mechanism]].
