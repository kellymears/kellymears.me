---
title: 'The Jira VS Code extension'
date: '2025-08-21'
lastmod: '2025-08-21'
tags: ['development', 'jira', 'vs code']
draft: false
summary: 'Making it slightly easier to work with Jira'
...
So, I was excited to learn that [the official Atlassian VS Code extension for Jira](https://marketplace.visualstudio.com/items?itemName=Atlassian.atlascode) 
is actually quite good. It allows me to manage a lot of my Jira ticketing tasks directly from my code editor. I can 
create, update, and transition tickets without the context switching, and I've found it's helping me to stay more focused 
