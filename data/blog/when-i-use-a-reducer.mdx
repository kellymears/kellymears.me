...
draft: false
summary: 'The argument over reduce is about style. The signal is in the types.'
---
...
Key normalization, arithmetic, and accumulator management — all in one callback. The reduce isn't adding clarity here; it's hiding complexity. A `for...of` with named helpers is clearer:
